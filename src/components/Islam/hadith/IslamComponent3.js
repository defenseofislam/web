  ...
  return (
    <Content style={{ padding: "24px" }}>
      <Typography>
        ...
        <Paragraph>
        <Text strong>The age of Ayesha (R.A.)</Text> at her marriage to{" "}
        <Text underline>Prophet Muhammad (PBUH)</Text> has been a subject of{" "}
        <Text type="danger">historical and theological debate</Text>.{" "}
        <Text italic>Traditional Islamic sources</Text> state that she was{" "}
        <Text code>six years old</Text> at the time of marriage and{" "}
        <Text code>nine when the marriage was consummated</Text>.{" "}
        <Text mark>Modern critics often question this narrative,</Text> while{" "}
        <Text strong>Islamic scholars defend it</Text> based on{" "}
        <Text type="success">historical context</Text>,{" "}
        <Text type="success">textual authenticity</Text>, and{" "}
        <Text type="success">jurisprudential reasoning</Text>. This article{" "}
        <Text italic>examines the primary sources</Text>,{" "}
        <Text italic>analyzes historical and cultural contexts</Text>,{" "}
        <Text italic>addresses common objections</Text>, and{" "}
        <Text italic>provides a scholarly perspective</Text> on this{" "}
        <Text type="warning">sensitive topic</Text>.
      </Paragraph>
